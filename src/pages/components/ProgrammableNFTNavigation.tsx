// src/pages/components/ProgrammableNFTNavigation.tsx
import React from 'react';
import BurnNFT from './BurnNFT';

interface ProgrammableNFTNavigationProps {
  selectedAssets: any[]; // Assuming selectedAssets array contains objects with a property for the token account address
}

const ProgrammableNFTNavigation: React.FC<ProgrammableNFTNavigationProps> = ({ selectedAssets }) => {
      ...
      <div className="menu-bar p-2 rounded-lg mb-4">
        ...
        <dialog id="burn_modal" className="modal modal-bottom sm:modal-middle">
          <div className="modal-box">
            <h3 className="font-bold text-lg">Burn NFT</h3>
            {/* {mintAddress && <BurnNFT mintAddress={mintAddress} asset={undefined} />} */}
...
export default ProgrammableNFTNavigation;
